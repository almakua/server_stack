...
echo ""
echo "  # Esegui manualmente il rinnovo"
echo "  systemctl start tailscale-cert-renewal.service"
echo ""
echo "  # Forza rinnovo (ignora scadenza)"
echo "  $INSTALL_DIR/scripts/renew-tailscale-certs.sh --force"
echo ""
echo "  # Visualizza log"
echo "  journalctl -u tailscale-cert-renewal.service"
echo "  cat /var/log/tailscale-cert-renewal.log"
echo ""
echo "  # Disabilita timer"
echo "  systemctl disable tailscale-cert-renewal.timer"
echo ""
